...
**What is Whiskers' strategy?**`,
        choices: [
            { text: "Focus on building alliances with neighborhood animals", nextChapter: 'friend_route_minigame' },
            { text: "Prioritize developing and mastering his bubble powers", nextChapter: 'power_route_minigame' },
            { text: "Take a direct aggressive approach to stop Dustzilla quickly", nextChapter: 'aggressive_route_minigame' }
        ],
        type: 'story'
    },
...
**Continue to Chapter 7A**`,
    ...
    friend_route_minigame:{
        id: 'friend_route_frogger',
        title:'Friend Route Challenge',
        type: 'minigame',
    ...
    power_route_minigame:{
        id: 'power_route_minigame',
        title:'Power Route Minigame',
        type: 'minigame',
        file: 'post_chapter_6',
        text: 'Power Route',
                choices: [
...
**Power Development Challenge**`,
    ...
    aggressive_route_minigame:{
        id: 'aggressive_route_frogger',
        title:'Aggressive Route Challenge',
        type: 'minigame',
...
**Continue to Chapter 8B**`,
        choices: [
            { text: "Continue to Chapter 8B", nextChapter: 'catDustChallengePower' }
        ],
        type: 'story'
    },

    catDustChallengePower: {
        id: 'catDustChallengePower',
...
**Continue to Chapter 8C**`,
        choices: [
            { text: "Face the monster", nextChapter: 'catDustChallengeSpeed' }
        ],
        type: 'story'
    },

    catDustChallengeSpeed: {
        id: 'catDustChallengeSpeed',
        title: 'Chapter 7BGame: Power Path',
        text: 'Whiskers stands at the threshold of the dusty hallway. Swirling dust bunnies block the way, daring him to dodge and leap with feline finesse. This is no ordinary passage—this is a test of agility, a game of reflexes. Are you ready?',
        choices: [
...
The true magic, he had learned, wasn't in the bubbles themselves—it was in bringing everyone together to care for each other and their shared world.`,
        choices: [
            { text: "Start a new adventure", nextChapter: 'postGameChallenge' }
        ],
        type: 'story',
...
Maplewood was safe, but more importantly, it was a place where mistakes could be forgiven and second chances were possible—for dust bunnies and guardian cats alike.`,
    ...
    postGameChallenge: {
        id: 'postGameChallenge',
        title: 'PostGame: Final Path',
        text: 'Whiskers stands at the threshold of the dusty hallway. Swirling dust bunnies block the way, daring him to dodge and leap with feline finesse. This is no ordinary passage—this is a test of agility, a game of reflexes. Are you ready?',
        choices: [
            { text: "The end", nextChapter: 'theEnd' }
        ],
        type: 'minigame',
        minigameId: 'asteroids',
        effects: { powerLevel: 'master', isolation: true }
    },
    theEnd: {
        id: 'theEnd',
